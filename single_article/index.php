...
<body>
 ...
 <button  class="connexion" onclick="window.location.href='../connexion/connexion.php'">Connexion</button>
 <button class="inscription" onclick="window.location.href='../inscription/inscription.php'">Inscription</button>
 </div>
 <?php } else { ?>
...
<script src="single_article.js"></script>
</html>